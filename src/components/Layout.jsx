...
function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* Header */}
      <header style={{ backgroundColor: '#224057' }} className="text-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/" className="flex items-center space-x-3 hover:opacity-90 transition-opacity">
              <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="#F8C762">
              ...
              <div>
                ...
                <span className="hidden sm:inline text-xs font-light ml-2 opacity-60">| AHA + Third Horizon</span>
              </div>
            </Link>
            <nav className="hidden md:flex items-center space-x-6">
              <Link
                to="/"
                style={location.pathname === '/' ? { color: '#F8C762', borderBottomColor: '#F8C762' } : {}}
      ...
      {/* Footer */}
      <footer style={{ backgroundColor: '#224057' }} className="text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                <svg className="w-6 h-6 flex-shrink-0" viewBox="0 0 24 24" fill="#F8C762">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                </svg>
